...
/// micphone mute statue
/// - Parameters:
///   - session:RTCAudioSession
///   - isMicrophoneMute: is microphone mute
- (void)audioSession:(RTC_OBJC_TYPE(RTCAudioSession) *)session didChangeMicrophoneMute:(BOOL)isMicrophoneMute;
